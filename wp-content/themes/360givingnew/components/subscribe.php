<div class="subscribe-section">
    <div class="subscribe-section__wrapper">
        <form action="<?php echo get_theme_mod( 'tsg_mailchimp_url', TSG_DEFAULTS['mailchimp_url'] ); ?>" method="POST" class="subscribe-section__form">
            ...
            <input type="text" name="<?php echo get_theme_mod( 'tsg_mailchimp_email_field', TSG_DEFAULTS['mailchimp_email_field'] ); ?>" id="<?php echo get_theme_mod( 'tsg_mailchimp_email_field', TSG_DEFAULTS['mailchimp_email_field'] ); ?>" placeholder="Subscribe to our newsletter">
