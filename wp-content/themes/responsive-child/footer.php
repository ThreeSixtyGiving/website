...
<div id="footer" class="clearfix">
	...
	<div id="footer-wrapper" class="container">
      ...
      <div class="grid col-620">
        <p class="footer-info">We support grantmakers to publish their grants data openly, to understand their data, and to use the data to create online tools that make grantmaking more effective.</p>
      </div>
      </div>
