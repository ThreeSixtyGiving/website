...
function tsg_accordion_register_block() {
	...
	wp_register_script(
		...
		array( 'wp-blocks', 'wp-i18n', 'wp-element', 'wp-editor' ),
		filemtime( plugin_dir_path( __FILE__ ) . '../assets/js/accordion-block.js' )
	);

	register_block_type( 'tsg/accordion-block', array(
		'editor_script' => 'tsg-accordion-block',
	) );
	
}
add_action( 'init', 'tsg_accordion_register_block' );
