...
// define( 'MB_TERM_META_URL', plugin_dir_url( __FILE__ ) );
// define( 'MB_TERM_META_DIR', plugin_dir_path( __FILE__ ) );

define( 'MB_TERM_META_URL', get_stylesheet_directory_uri() . '/framework/includes/metabox_term/' );
define( 'MB_TERM_META_DIR', get_template_directory() . '/framework/includes/metabox_term/' );
